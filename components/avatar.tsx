    ...
    <div className="relative group mb-10 animate-float">
      ...
      <div className="relative w-36 h-36 md:w-44 md:h-44 rounded-full p-1.5 bg-background">
        <div className="w-full h-full rounded-full bg-cover bg-center border-2 border-white/10 overflow-hidden bg-surface shadow-2xl">
          <img alt="Developer Avatar" className="w-full h-full object-cover" src="/professional-developer-portrait-dark-background.png" />
        </div>
      </div>
      ...
      <div className="absolute bottom-2 right-2 bg-background border border-white/10 rounded-full px-4 py-1.5 flex items-center gap-2 shadow-2xl backdrop-blur-md">
        ...
        <span className="text-[11px] font-bold uppercase tracking-widest text-white/90">Available Now</span>
      </div>
    </div>
  )
}
